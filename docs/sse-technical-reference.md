...
implemented by `nlmixr2sse`. It is a user-facing specification of the
...
models is given by [Dosne et al. (2016)](https://doi.org/10.1007/s10928-015-9460-y), and [Ueckert et al. (2016)](https://doi.org/10.1007/s10928-016-9468-y) develop the
...
with `nlmixr2utils::parseRawResultsParams()` (the raw results file can be generated by bootstrap using `nlmixr2boot`, for example). It applies `offsetRawres` (default
...
[Dosne et al. (2017)](https://doi.org/10.1007/s10928-017-9542-0) discuss why a covariance-matrix approximation can be
...
bugs. [Barnard, McCulloch, and Meng (2000)](https://www3.stat.sinica.edu.tw/statistica/j10n4/10-4.htm) discuss the inflexibility created by a
...
reference; [Self and Liang (1987)](https://doi.org/10.1080/01621459.1987.10478472) describe the resulting nonstandard
...
PsN and `nlmixr2sse` fit the [Ueckert, Karlsson & Hooker (2016)](https://doi.org/10.1007/s10928-016-9468-y)
...
There is also a narrow exact-zero edge case: PsN's own MLE
